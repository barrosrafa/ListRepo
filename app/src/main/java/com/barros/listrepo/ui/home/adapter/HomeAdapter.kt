...
import com.barros.listrepo.databinding.WatchCardItemBinding
import com.barros.listrepo.model.Repository
import com.barros.listrepo.utils.Constants.Cache.VISIBLE_IMAGES_THRESHOLD
import com.barros.listrepo.utils.Extensions
...
internal class HomeAdapter(
...
) : ListAdapter<Repository, RecyclerView.ViewHolder>(RepositoryDiff) {

    private var repositories: List<Repository> = emptyList()
    private lateinit var viewBinding: WatchCardItemBinding

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val inflater = LayoutInflater.from(parent.context)
        viewBinding = WatchCardItemBinding.inflate(inflater)

        return ItemsViewHolder(
            WatchCardItemBinding.inflate(
    ...
    fun update(repos: List<Repository>) {
    ...
    inner class ItemsViewHolder(
        ...
        fun update(repositoryItem: Repository) {
